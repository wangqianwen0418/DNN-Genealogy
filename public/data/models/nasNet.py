...
based on https://github.com/titu1994/Keras-NASNet/blob/master/nasnet.py
'''
"""NASNet-A models for Keras
...
if __name__ == "__main__":
    ...
    # with open("nasnet-small.json", "w") as jsonf:
    #     jsonf.write(json_string)
    # jsonf.close()

    # model = NASNetLarge(weights=None)
    # model.summary()
    # json_string = model.to_json()
    # with open("nasnet-large.json", "w") as jsonf:
    #     jsonf.write(json_string)
    # jsonf.close()
